...
<h2><?php esc_html_e( 'Customer details', 'bp-custom-order-status' );?></h2>

<?php if ( $billing_email = $order->get_billing_email() ): ?>
	<p><strong><?php esc_html_e( 'Email:', 'bp-custom-order-status' );?></strong> <?php echo esc_html( $billing_email ); ?></p>
<?php endif;?>

<?php if ( $billing_phone = $order->get_billing_phone() ): ?>
	<p><strong><?php esc_html_e( 'Tel:', 'bp-custom-order-status' );?></strong> <?php echo esc_html( $billing_phone ); ?></p>
<?php endif;?>
